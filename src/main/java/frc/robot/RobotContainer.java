...
public class RobotContainer {
    ...
    private final LoggedNetworkString selectedLevel = new LoggedNetworkString("Selected Level", "None");
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand(
                ...
                ElevatorCommands.moveSafe(
                        elevatorMotor,
                        elbowMotor,
                        () -> ElevatorCommands.ELEVATOR_HEIGHT_PRESETS.L_THREE_CORAL).withTimeout(1));
        NamedCommands.registerCommand(
                "Four",
                ElevatorCommands.moveSafe(
                        elevatorMotor,
                        elbowMotor,
                        () -> ElevatorCommands.ELEVATOR_HEIGHT_PRESETS.L_FOUR_CORAL).withTimeout(1));
        NamedCommands.registerCommand(
                "CoralWait",
                ElevatorCommands.moveSafe(
        ...
        NamedCommands.registerCommand("AlignToI", DriveCommands.autoAlignAuto(vision, "Left", "IJ"));

        NamedCommands.registerCommand("AlignToK", DriveCommands.autoAlignAuto(vision, "Left", "KL"));
    ...
    private void configureButtonBindings() {
        ...
        endEffectorMotor.setDefaultCommand(
                Flywheel.setVoltage(
                        endEffectorMotor,
                        () -> 6.0
        ...
        new Trigger(
                () -> ControllerUtil.getIndex(coPilotController.getLeftX(), coPilotController.getLeftY()) == 4)
                .onTrue(new InstantCommand(() -> selectedReef.set("AB")));

        new Trigger(
                () -> ControllerUtil.getIndex(coPilotController.getLeftX(), coPilotController.getLeftY()) == 3)
                .onTrue(new InstantCommand(() -> selectedReef.set("CD")));

        new Trigger(
                () -> ControllerUtil.getIndex(coPilotController.getLeftX(), coPilotController.getLeftY()) == 2)
                .onTrue(new InstantCommand(() -> selectedReef.set("EF")));

        new Trigger(
                () -> ControllerUtil.getIndex(coPilotController.getLeftX(), coPilotController.getLeftY()) == 1)
                .onTrue(new InstantCommand(() -> selectedReef.set("GH")));

        new Trigger(
                () -> ControllerUtil.getIndex(coPilotController.getLeftX(), coPilotController.getLeftY()) == 0)
                .onTrue(new InstantCommand(() -> selectedReef.set("IJ")));

        new Trigger(
                () -> ControllerUtil.getIndex(coPilotController.getLeftX(), coPilotController.getLeftY()) == 5)
