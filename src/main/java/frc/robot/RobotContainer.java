...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("Score", ElevatorCommands.scorePreset(elbowMotor).withTimeout(1));

    NamedCommands.registerCommand(
        "AlignToE",
        DriveCommands.autoAlignAuto(
            vision, rightCoralRotationMotor, leftCoralRotationMotor, "Left", "EF"));

    NamedCommands.registerCommand(
        "AlignToF",
        DriveCommands.autoAlignAuto(
            vision, rightCoralRotationMotor, leftCoralRotationMotor, "Right", "EF"));

    NamedCommands.registerCommand(
        "AlignToC",
        DriveCommands.autoAlignAuto(
            vision, rightCoralRotationMotor, leftCoralRotationMotor, "Left", "CD"));

    NamedCommands.registerCommand(
        "AlignToD",
        DriveCommands.autoAlignAuto(
            vision, rightCoralRotationMotor, leftCoralRotationMotor, "Right", "CD"));

    NamedCommands.registerCommand(
        "AlignToI",
        DriveCommands.autoAlignAuto(
            vision, rightCoralRotationMotor, leftCoralRotationMotor, "Left", "IJ"));

    NamedCommands.registerCommand(
        "AlignToK",
        DriveCommands.autoAlignAuto(
            vision, rightCoralRotationMotor, leftCoralRotationMotor, "Left", "KL"));
