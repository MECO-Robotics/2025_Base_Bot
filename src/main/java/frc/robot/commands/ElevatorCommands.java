...
public class ElevatorCommands {
    ...
    public static final class ELEVATOR_HEIGHT_PRESETS {
        ...
        public static final CoralPreset HANDOFF = new CoralPreset("HandOff", -0.083, Rotation2d.fromRotations(-0.25));

        public static final CoralPreset STOW = new CoralPreset("Stow", 0.0, Rotation2d.fromRotations(0.25));

        public static final CoralPreset SAFE = new CoralPreset("SAFE", 0.3, Rotation2d.fromRotations(0));

        public static final CoralPreset L_ONE_CORAL = new CoralPreset("L1", 0.35, Rotation2d.fromRotations(-0.21));

        public static final CoralPreset L_TWO_CORAL = new CoralPreset("L2", -0.05, Rotation2d.fromDegrees(60));

        public static final CoralPreset L_THREE_CORAL = new CoralPreset("L3", 0.3, Rotation2d.fromDegrees(60));

        public static final CoralPreset L_FOUR_CORAL = new CoralPreset("L4", 0.9, Rotation2d.fromDegrees(65));
        ...
        public static final CoralPreset WAIT_FOR_CORAL = new CoralPreset("Wait_for_Coral", 0.15,
    ...
    public static final LoggedTunableNumber tinyBitDown = new LoggedTunableNumber("Tiny Bit Down", 0.15);
        ...
        return Commands.either(
                ...
                PositionJoint.setPosition(elevatorMotor, () -> preset.getElevatorPos())
                        .alongWith(
                                ...
                                Commands.waitUntil(
                                        () -> elevatorMotor.getPosition() > ELEVATOR_HEIGHT_PRESETS.SAFE
                                                .getElevatorPos())
                                        .andThen(
                                ...
                                .andThen(
                                        PositionJoint.setPosition(wristMotor, () -> preset.getWristPos().getRotations())
                                                ...
                                                .alongWith(
                                                        Commands.waitUntil(
                                                                () -> wristMotor
                                                                        .getPosition() > ELEVATOR_HEIGHT_PRESETS.SAFE
                                                                                .getWristPos()
                                                                                .getRotations()))
                                                .andThen(
                                                        PositionJoint.setPosition(
    ...
    public static Command moveSafe(
        ...
        return Commands.either(
                ...
                () -> elevatorMotor.getDesiredPosition() == ELEVATOR_HEIGHT_PRESETS.HANDOFF.getElevatorPos()
                        && wristMotor.getDesiredPosition() == ELEVATOR_HEIGHT_PRESETS.HANDOFF.getWristPos()
                                .getRotations());
    }
